...
# ==================== 强制设置 UTF-8 编码 ====================
os.environ['KIVY_ENCODING'] = 'utf-8'
...
try:
    ...
    # 默认字体
    LabelBase.register(name='DefaultFont',
                       fn_regular='/system/fonts/NotoSansCJK-Regular.ttc')
except:
    pass
...
# 设置默认字体
from kivy.core.text import LabelBase
LabelBase._default_font_name = 'NotoSansCJK'
...
class PriceApp(MDApp):
    def build(self):
        ...
        self.theme_cls.font_styles.update({
            "H1": ["NotoSansCJK", 96, False, -1.5],
            "H2": ["NotoSansCJK", 60, False, -0.5],
            "H3": ["NotoSansCJK", 48, False, 0],
            "H4": ["NotoSansCJK", 34, False, 0.25],
            "H5": ["NotoSansCJK", 24, False, 0],
            "H6": ["NotoSansCJK", 20, False, 0.15],
            "Subtitle1": ["NotoSansCJK", 16, False, 0.15],
            "Subtitle2": ["NotoSansCJK", 14, False, 0.1],
            "Body1": ["NotoSansCJK", 16, False, 0.5],
            "Body2": ["NotoSansCJK", 14, False, 0.25],
            "Button": ["NotoSansCJK", 14, True, 1.25],
            "Caption": ["NotoSansCJK", 12, False, 0.4],
            "Overline": ["NotoSansCJK", 10, True, 1.5],
        })
